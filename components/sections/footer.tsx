...
//         &copy; {new Date().getFullYear()} Gerakan Developer Tanah Air. All rights reserved.
//       </h1>
//     </footer>
//   );
// };
...
const Footer = () => {
  return (
    <footer className="h-fit w-full p-10 bg-purple-300 flex items-center justify-between border-t-2 border-solid border-black">
      <p className="text-xs text-black">
        Copyright © {new Date().getFullYear()} nrmnqdds. Powered by Gerakan
        Developer Tanah Air
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://x.com/nrmnqdds" icon={XIcon}>
          Follow me on X
        </SocialLink>
        <SocialLink href="http://github.com/nrmnqdds" icon={GitHubIcon}>
          Follow me on GitHub
        </SocialLink>
      </div>
    </footer>
