...
>(
	(
		...
		const addFileToSet = useCallback(
			...
			[reSelectAll, maxFiles, maxSize, onValueChange],
		);
		...
		const onDrop = useCallback(
			...
			[reSelectAll, addFileToSet, onValueChange, maxSize],
		);
	...
	return (
		...
		>
			...
			>
				...
				<RemoveIcon className="text-red-400 w-6 h-6 hover:stroke-destructive duration-200 ease-in-out" />
			</button>
		</div>
	);
});
